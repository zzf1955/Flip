...
from src.core.config import (G1_URDF, MESH_DIR, BEST_PARAMS, SKIP_MESHES, OUTPUT_DIR,
...
from src.core.render import render_overlay, render_mesh_on_image
from src.core.smplh import SMPLHForIK, IKSolver, extract_g1_targets
...
def main():
    ...
    out_dir = os.path.join(OUTPUT_DIR, "human", "smplh_ik")
