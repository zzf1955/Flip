...
Usage:
  python -m src.pipeline.sam2_segment --episode 4 --start 5 --duration 5 --mode box
  python -m src.pipeline.sam2_segment --episode 4 --start 5 --duration 5 --mode point
"""
...
SAM2_OUTPUT_DIR = os.path.join(OUTPUT_DIR, "inpaint/sam2_segment")
