...
Usage:
  python -m src.pipeline.archive.inpaint_retarget.retarget_video --task G1_WBT_Inspire_Pickup_Pillow_MainCamOnly --episode 0
  python -m src.pipeline.archive.inpaint_retarget.retarget_video --task ... --start 2 --duration 5
  python -m src.pipeline.archive.inpaint_retarget.retarget_video --task ... --no-refine  # faster, skip arm IK
"""
