...
Usage:
  python -m src.pipeline.archive.patch.hand_patch_4s --task all --resume
  python -m src.pipeline.archive.patch.hand_patch_4s --task Inspire_Pickup_Pillow_MainCamOnly
"""
