...
from config import G1_URDF, MESH_DIR, SKIP_MESHES, DATASET_ROOT, get_hand_type
from camera_models import project_points_cv
from video_inpaint import (build_q, do_fk, parse_urdf_meshes, preload_meshes,
                            make_camera)
from render_3view import get_color as _get_color_hex
import pandas as pd
...
def main():
    ...
    # Load params
    params_path = os.path.join(BASE_DIR,
        "test_results/kp_optim/pso_pillow/best_params.json")
    ...
    out_path = os.path.join(BASE_DIR,
        "test_results/kp_optim/pso_pillow/f090_scale_compare.png")
