...
from camera_models import get_model, project_points_cv
...
def main():
    ...
    # Patch video_inpaint's CAMERA_MODEL if using pinhole
    import video_inpaint as vi
    vi.CAMERA_MODEL = cam_model_name
    ...
    # Output
    out_dir = os.path.join(OUTPUT_DIR, "lit_overlay")
