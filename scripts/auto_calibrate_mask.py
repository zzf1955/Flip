...
import video_inpaint
from video_inpaint import (
    build_q, do_fk, parse_urdf_meshes, preload_meshes, render_mask,
)
...
def main():
    ...
    if args.camera_model and args.camera_model != CAMERA_MODEL:
        video_inpaint.CAMERA_MODEL = args.camera_model
    ...
    out_dir = os.path.join(BASE_DIR, "output", "camera_estimation")
