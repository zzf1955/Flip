...
Produces:
  - test_results/debug_retarget_points/<tag>.png  (overlay image)
...
from debug_keypoints import detect_keypoints_from_alpha
...
def main():
    ...
    annotated = detect_keypoints_from_alpha(args.png, expected_count=4)
    ...
    # ── Save ──
    out_dir = os.path.join(OUTPUT_DIR, "debug_retarget_points")
