...
sys.path.insert(0, os.path.join(BASE_DIR, "scripts", "archive"))

from config import (G1_URDF, MESH_DIR, BEST_PARAMS, SKIP_MESHES,
                     DATASET_ROOT, OUTPUT_DIR, get_hand_type, get_skip_meshes,
                     CAMERA_MODEL)
from camera_models import get_model, model_is_fisheye, project_points_cv
from video_inpaint import (build_q, do_fk, parse_urdf_meshes, preload_meshes,
                            make_camera)
from auto_calibrate_grad import (CameraParams, _build_rotation)
from render_3view import BODY_GROUPS, GROUP_COLORS, get_color as _get_color_hex
...
OUT_DIR = os.path.join(OUTPUT_DIR, "kp_optim")
