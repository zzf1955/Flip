...
# 55 segments split as: 0-9, 10-19, 20-28, 29-37, 38-46, 47-54
OFFSETS=(0 10 20 29 38 47)
LIMITS=(10 10 9 9 9 8)
CUDAS=(0 0 0 1 1 1)
pids=()
for i in "${!OFFSETS[@]}"; do
  log="logs/segment_pipeline/inspire_ep23_w${i}.log"
  (
  ...
  pid=$!
  pids+=("$pid")
  echo "$pid" > "logs/segment_pipeline/inspire_ep23_w${i}.pid"
...
echo "6way workers finished status=$status"
exit "$status"
