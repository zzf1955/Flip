...
> **归档说明（2026-04-24 / T032）**：FunControl baseline 已退出当前维护主线，`src.pipeline.train_lora` 已删除。本文仅作为历史记录保留，不要按本文命令启动新实验。当前训练入口见 [`../pipeline/training_infra.md`](../pipeline/training_infra.md)。
